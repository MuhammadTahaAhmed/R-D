const { CLOUDINARY_CONFIG, validateCloudinaryConfig } = require('./cloudinary');
 ...
 */
const uploadToCloudinary = async (fileBlob, fileName, onProgress = null) => {
...
const uploadGlbToCloudinary = async (glbBlob, avatarId, onProgress = null) => {
