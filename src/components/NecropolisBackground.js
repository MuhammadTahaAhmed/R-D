...
// Fullscreen Three.js background inspired by the provided Necropolis scene
export default function NecropolisBackground({ className = 'absolute inset-0 -z-10 pointer-events-none' }) {
  ...
  useEffect(() => {
    ...
    scene.fog = new THREE.FogExp2(0x000811, 0.002);
    ...
    const spotLight = new THREE.SpotLight(0x00ffaa, 1, 100, Math.PI / 4, 0.5, 2);
